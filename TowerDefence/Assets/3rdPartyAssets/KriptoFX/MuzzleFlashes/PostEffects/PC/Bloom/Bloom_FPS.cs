...
namespace UnityStandardAssets.CinematicEffects
{
    ...
    public class Bloom_FPS : MonoBehaviour
    {
        ...
        public struct Settings
        {
            ...
            [MinAttribute_FPS(0f), Tooltip("Amount of lens dirtiness.")]
        ...
        public Shader shader
        {
            get
            {
                if (m_Shader == null)
                {
                    const string shaderName = "Hidden/Image Effects/Cinematic/Bloom_FPS";
        ...
        {
            if (!ImageEffectHelper_FPS.IsSupported(shader, true, false, this))
                enabled = false;
        }
