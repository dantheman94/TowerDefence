    ...
    protected void OnCollisionEnter(Collision collision) {
        ...
        if (worldObj != null) {
                ...
                if (_WeaponAttached != null) {
                    ...
                    if (unitObj.Team != _WeaponAttached.GetUnitAttached().Team) {
                        ...
                        switch (unitObj.UnitType) {
                            ...
                            case Unit.EUnitType.Undefined:          { unitObj.Damage(_Damages.DamageDefault * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetUnitAttached()); break; }
                            case Unit.EUnitType.CoreMarine:         { unitObj.Damage(_Damages.DamageCoreInfantry * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetUnitAttached()); break; }
                            case Unit.EUnitType.AntiInfantryMarine: { unitObj.Damage(_Damages.DamageAntiInfantryMarine * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetUnitAttached()); break; }
                            case Unit.EUnitType.Hero:               { unitObj.Damage(_Damages.DamageHero * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetUnitAttached()); break; }
                            case Unit.EUnitType.CoreVehicle:        { unitObj.Damage(_Damages.DamageCoreVehicle * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetUnitAttached()); break; }
                            case Unit.EUnitType.AntiAirVehicle:     { unitObj.Damage(_Damages.DamageAntiAirVehicle * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetUnitAttached()); break; }
                            case Unit.EUnitType.MobileArtillery:    { unitObj.Damage(_Damages.DamageMobileArtillery * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetUnitAttached()); break; }
                            case Unit.EUnitType.BattleTank:         { unitObj.Damage(_Damages.DamageBattleTank * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetUnitAttached()); break; }
                            case Unit.EUnitType.CoreAirship:        { unitObj.Damage(_Damages.DamageCoreAirship * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetUnitAttached()); break; }
                            case Unit.EUnitType.SupportShip:        { unitObj.Damage(_Damages.DamageSupportShip * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetUnitAttached()); break; }
                            case Unit.EUnitType.HeavyAirship:       { unitObj.Damage(_Damages.DamageHeavyAirship * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetUnitAttached()); break; }
                            default: break;
                        }
                    }
                }
            ...
            // Damage the world object
                ...
                // Destroy projectile
                worldObj.Damage(_Damages.DamageDefault * dm.GetDifficultyModifier(Unit.EUnitType.Undefined, worldObj.Team == GameManager.Team.Defending, mod));
                OnDestroy();
            }
        }
    }
                    ...
                    if (_WeaponAttached.GetTowerAttached() != null) {
                        ...
                        if (unitObj.Team != _WeaponAttached.GetTowerAttached().Team) {
                            ...
                            switch (unitObj.UnitType) {
                                ...
                                case Unit.EUnitType.Undefined:          { unitObj.Damage(_Damages.DamageDefault * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetTowerAttached()); break; }
                                case Unit.EUnitType.CoreMarine:         { unitObj.Damage(_Damages.DamageCoreInfantry * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetTowerAttached()); break; }
                                case Unit.EUnitType.AntiInfantryMarine: { unitObj.Damage(_Damages.DamageAntiInfantryMarine * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetTowerAttached()); break; }
                                case Unit.EUnitType.Hero:               { unitObj.Damage(_Damages.DamageHero * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetTowerAttached()); break; }
                                case Unit.EUnitType.CoreVehicle:        { unitObj.Damage(_Damages.DamageCoreVehicle * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetTowerAttached()); break; }
                                case Unit.EUnitType.AntiAirVehicle:     { unitObj.Damage(_Damages.DamageAntiAirVehicle * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetTowerAttached()); break; }
                                case Unit.EUnitType.MobileArtillery:    { unitObj.Damage(_Damages.DamageMobileArtillery * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetTowerAttached()); break; }
                                case Unit.EUnitType.BattleTank:         { unitObj.Damage(_Damages.DamageBattleTank * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetTowerAttached()); break; }
                                case Unit.EUnitType.CoreAirship:        { unitObj.Damage(_Damages.DamageCoreAirship * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetTowerAttached()); break; }
                                case Unit.EUnitType.SupportShip:        { unitObj.Damage(_Damages.DamageSupportShip * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetTowerAttached()); break; }
                                case Unit.EUnitType.HeavyAirship:       { unitObj.Damage(_Damages.DamageHeavyAirship * dm.GetDifficultyModifier(unitObj, mod), _WeaponAttached.GetTowerAttached()); break; }
                                default: break;
                            }
                        }
                    }
